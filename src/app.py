...
activities = {
    ...
    "Tennis Club": {
        "description": "Recreational and competitive tennis playing",
    ...
    "Debate Club": {
        ...
        "max_participants": 16,
        "participants": ["sarah@mergington.edu", "nathan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "STEM competitions in physics, chemistry, and biology",
